...
Scene loadBoatScene(GLFWwindow* window)
{
    ...
    pl.translate(glm::vec3(0.0, 0.06f, -0.08f));
    ...
    lantern.translate(glm::vec3(0.0, 0.06f, -0.08f));
...
int main() 
{
    ...
    Camera camera(glm::vec3(0.0f, 0.3f,-2.6f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
